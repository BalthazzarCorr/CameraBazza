...
namespace CameraBazza.Data.Migrations
{
    ...
    [Migration("20171122204229_newUserColons")]
    partial class newUserColons
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CameraBazza.Data.Models.Camera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CameraBazza.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("CameraBazza.Data.Models.Camera", b =>
                {
                    b.HasOne("CameraBazza.Data.Models.User", "User")
                        .WithMany("Cameras")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CameraBazza.Data.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
